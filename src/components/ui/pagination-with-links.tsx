      ...
      items.push(
        <PaginationItem key={totalPageCount}>
          <PaginationLink
            ...
            className={cn('cursor-pointer', {
              'text-accent-foreground': page === totalPageCount
            })}
        ...
        <PaginationContent className='max-sm:gap-0'>
          <PaginationItem>
            <PaginationPrevious
              ...
              className={cn('cursor-pointer', {
                'cursor-not-allowed pointer-events-none opacity-50': page === 1
              })}
